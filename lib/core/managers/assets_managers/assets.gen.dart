...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/salloum_logo.png
  AssetGenImage get salloumLogo =>
      const AssetGenImage('assets/images/salloum_logo.png');

  /// File path: assets/images/user.jpg
  AssetGenImage get user => const AssetGenImage('assets/images/user.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [salloumLogo, user];
}
